...
berlin_highways_sf %>% write_rds("data/berlin_highways_sf.rds")
# berlin_highways_sf <- read_rds("data/berlin_highways_sf.rds")
...
berlin_medium_streets_sf %>% write_rds("data/berlin_medium_streets_sf.rds")
# berlin_medium_streets_sf <- read_rds("data/berlin_medium_streets_sf.rds")
...
# * Customer Data ----
berlin_customers_sf <- read_rds("data/berlin_customers_sf.rds") %>%
    rowid_to_column(var = "customer_id")

# * Warehouse Data ----
berlin_distributors_sf <- read_rds("data/berlin_distributors_sf.rds") %>%
